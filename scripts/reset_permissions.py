...
desired_ownerships = {
    'epigenomics'         : {'owner':'root', 'group':'aals_members', 'mode':mode['owner can do anything, group can read and execute, others have no permissions']},
    'genomics'            : {'owner':'root', 'group':'aals_members', 'mode':mode['owner can do anything, group can read and execute, others have no permissions']},
    'proteomics'          : {'owner':'root', 'group':'aals_members', 'mode':mode['owner can do anything, group can read and execute, others have no permissions']},
    'transcriptomics'     : {'owner':'root', 'group':'aals_members', 'mode':mode['owner can do anything, group can read and execute, others have no permissions']},

    'genomics_other'      : {'owner':'root', 'group':'aals_members', 'mode':mode['owner can do anything, group can read and execute, others have no permissions']},
